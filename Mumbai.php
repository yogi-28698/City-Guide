...
<nav class="navbar navbar-expand-lg navbar-dark">
    <a class="navbar-brand" href="./index.php">Mumbai City</a>
...
<h1 style="text-align:center; margin:20px 0 20px 0">Explore Mumbai City</h1>

<?php
  include_once 'Maps/map_mumbai.php';
?>
